...
export const Container = () => {
    ...
    const [date, setDate] = useState(() => new Date()); // Анхны утгыг шинэчилнэ
    const [hydrated, setHydrated] = useState(false); // Клиент рендерлэгдсэнийг илэрхийлнэ
    ...
    useEffect(() => {
        getData();
        setHydrated(true); // Клиент талд бүрэн рендер болсон үед шинэчлэгдэнэ
    }, []);
    ...
    if (!hydrated) {
        return null; // Клиент талд рендерлэгдэж дуустал юу ч харуулахгүй
    }
                            ...
                            <div className='flex flex-col'>
                                <div className="w-[894px] h-[80px] flex justify-between items-center">
                                    <div className="flex justify-center items-center gap-4">
                                        <div className='flex justify-center items-center gap-4'>
                                            <Button className="bg-[#E5E7EB]" onClick={handlePrevDay}>
                                                <ZuunSum />
                                            </Button>
                                            <span className="mx-4">
                                                {date.toDateString()} {/* Одоогийн өдрийг харуулна */}
                                            </span>
                                            <Button className="bg-[#E5E7EB]" onClick={handleNextDay}>
                                                <BaruunSum />
                                            </Button>
                                        </div>
                                    </div>
